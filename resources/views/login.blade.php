            ...
            <div class="col-md-4">
                ...
                <main class="form-signin w-100 m-auto">
                    ...
                    <small class="d-block text-center mt-3">
                        Lupa password? <a class="text-decoration-none" href="/konfirmasi-email">Reset Password</a>
                    </small>
                    <small class="d-block text-center">
                        Belum daftar? <a class="text-decoration-none" href="/register">Daftar Sekarang!</a>
                    </small>
                </main>
            </div>
        </div>
